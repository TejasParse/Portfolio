  ...
  return (
    <div className="lg:h-screen flex flex-col justify-center px-4 md:pe-24 py-3 md:py-0">
      ...
      <div className="md:text-lg mb-3 md:mb-1">
        ...
        maintaining a perfect GPA of <b>4.0</b>. I am proud to be one of the 1000s chosen to work part-time
        as a Software Developer at Psych For Life, a startup under the Department of Psychology at ASU.
        With over a <b>year and a half of software development experience</b>, I continue to refine my skills and
      ...
      <div className="md:text-lg mb-3 md:mb-1">
        ...
        <b> I am now actively seeking Summer Internship Opportunities in Software Development and Machine Learning.</b>
